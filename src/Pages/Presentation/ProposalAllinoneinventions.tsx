    ...
    const translations = {
        ...
        EN: {
            ...
            assessment: {
                ...
                text3: "Traffic source from organic search is low with 28%, there haven't been blogs posted since last year.",
                text4: "Searching for All in one Inventions shows competitors that appear before your site (excluding the sponsored result)"
            },
            exploration: {
                title: "Exploration",
        ...
        EN: [
            {
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        timeScope: "",
                        description: "Analysis of audience behavior, platform performance, and current content to identify growth opportunities and content gaps."
                    },
                    {
                        number: 3,
                        title: "Lead Tracking",
                    ...
                    },
                    {
                        ...
                        title: "Reporting",
                        timeScope: "",
                        description: "Clear summary report with insights and prioritized recommendations across SEO, website, content, and social media."
                    }
